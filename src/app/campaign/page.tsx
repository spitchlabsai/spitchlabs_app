...
//   purpose: string;
//   script_text: string;
//   fileName?: string; // Kept for UI compatibility, but backend uses script_text
...
// const API_BASE = process.env.NEXT_PUBLIC_API_URL || "https://apiend.spitchlabs.com";
...
//     e.preventDefault();
//     if (!newName.trim() || !newPurpose.trim() || !user?.id) return;

//     try {
//       const payload = {
//         name: newName.trim(),
//         purpose: newPurpose.trim(),
//         script_text: newScript.trim(),
//       };
...
//     if (!user?.id || !window.confirm("Are you sure you want to delete this campaign?")) return;
//     try {
//       const response = await fetch(`${API_BASE}/campaigns/${user.id}/${campaign.id}`, {
//         method: "DELETE",
//       });
//       if (response.ok) {
//         await fetchCampaigns();
...
//                 multiline
//                 minRows={4}
//                 placeholder="Enter the system instruction for the AI (e.g. 'You are a salesman...')"
//               />
...
// app/campaigns/page.tsx or pages/campaigns.tsx
